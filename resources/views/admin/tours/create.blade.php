...
<div class="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
    ...
    <form action="{{ route('admin.tours.store') }}" method="POST" class="space-y-6 bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        ...
        <div class="flex justify-end">
            <button type="submit" class="inline-flex items-center rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700">Save Tour</button>
        </div>
    </form>
</div>
@endsection
