...
<div class="container mx-auto py-8">
    ...
    <form action="{{ route('admin.tours.update', $tour->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6 max-w-3xl">
        ...
        <div class="flex space-x-4">
            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700" style="background-color: var(--brand-orange); color: white;">Update Tour</button>
            <a href="{{ route('admin.tours.show', $tour->id) }}" class="px-4 py-2 bg-gray-300 text-gray-800 rounded hover:bg-gray-400" style="background-color: var(--brand-orange); color: white;">Cancel</a>
        </div>
    </form>
</div>
@endsection
