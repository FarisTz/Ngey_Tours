		...
		<div class="flex min-h-screen">
			<aside class="hidden w-72 flex-none flex-col bg-gray-900 text-gray-100 md:flex">
				...
				<nav class="flex flex-1 flex-col gap-1 px-4 py-6 text-sm">
					...
					<a href="#" class="rounded-xl px-4 py-3 font-medium text-gray-300 transition border-l-4 border-transparent" onmouseover="this.style.backgroundColor = 'rgba(249, 109, 0, 0.2)'; this.style.color = '#F96D00';" onmouseout="this.style.backgroundColor = ''; this.style.color = 'rgb(209, 213, 219)';">Booking</a>
