...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="/"> <img width="45px" src="logo.png" alt="Ngey Tours"> Ngey Tour & Safari</a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item {{ request()->is('destination') ? 'active' : '' }}"><a href="{{ route('destination') }}" class="nav-link">Destination</a></li>
                    <li class="nav-item {{ request()->is('testimonials') ? 'active' : '' }}"><a href="{{ route('testimonials') }}" class="nav-link">Testimonial</a></li>
