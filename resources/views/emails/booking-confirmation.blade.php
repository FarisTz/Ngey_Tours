...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p>Thank you for choosing Ngey Tours</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="booking-reference">
                ...
                <p style="margin: 10px 0 0; font-size: 12px;">Please keep this reference for future communication</p>
            </div>
                ...
                <div>
                    ...
                    <p style="margin-top: 10px; font-size: 14px;">
                        @if($booking->status == 'pending')
                            Your booking is pending confirmation. We will notify you once confirmed.
